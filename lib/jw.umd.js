      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
          vue.createVNode(_component_el_table, vue.mergeProps({
            ...
            onSelectionChange: vue.unref(methods).onSelectionChange,
            onCurrentChange: vue.unref(methods).onCurrentChange
          }, _ctx.$attrs), {
            default: vue.withCtx(() => [
              vue.unref(baseConfig).index ? (vue.openBlock(), vue.createBlock(_component_el_table_column, {
                key: 0,
                type: "index",
                index: vue.unref(methods).indexFun,
                width: "50",
                align: "center"
              ...
              vue.createVNode(_sfc_main$8, { columns: _ctx.columns }, vue.createSlots({ _: 2 }, [
          ...
          vue.unref(baseConfig).pagination ? (vue.openBlock(), vue.createBlock(_component_el_pagination, {
            ...
            onCurrentChange: vue.unref(methods).handleCurrentChange,
            onSizeChange: vue.unref(methods).handleSizeChange
                ...
                item.show ? (vue.openBlock(), vue.createBlock(_component_el_form_item, {
                  ...
                  default: vue.withCtx(() => [
                    item.slot ? vue.renderSlot(_ctx.$slots, item.slot, {
                      key: 0,
                      data: item
                    }, void 0, true) : (vue.openBlock(), vue.createBlock(_sfc_main$5, {
                      key: 1,
                      item,
        ...
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$2, [
                ...
                vue.createVNode(_component_el_space, null, {
                  default: vue.withCtx(() => [
                    vue.createVNode(_component_el_button, {
                      ...
                      onClick: ($event) => vue.unref(methods).del(item.id)
                    ...
                    __props.btnType == "right" && index == vue.unref(lists).length - 1 ? (vue.openBlock(), vue.createBlock(_component_el_button, {
                      ...
                      onClick: _cache[0] || (_cache[0] = ($event) => vue.unref(methods).add())
          ...
          __props.btnType == "bottom" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2, [
            vue.createVNode(_component_el_button, {
              ...
              type: "primary",
              style: { width: "100%" },
              onClick: _cache[1] || (_cache[1] = ($event) => vue.unref(methods).add())
            }, {
              default: vue.withCtx(() => [
