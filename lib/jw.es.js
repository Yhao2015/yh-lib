    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(_component_el_table, mergeProps({
          ...
          onSelectionChange: unref(methods2).onSelectionChange,
          onCurrentChange: unref(methods2).onCurrentChange
        }, _ctx.$attrs), {
          default: withCtx(() => [
            unref(baseConfig).index ? (openBlock(), createBlock(_component_el_table_column, {
              key: 0,
              type: "index",
              index: unref(methods2).indexFun,
              width: "50",
              align: "center"
            ...
            createVNode(_sfc_main$9, { columns: _ctx.columns }, createSlots({ _: 2 }, [
        ...
        unref(baseConfig).pagination ? (openBlock(), createBlock(_component_el_pagination, {
          ...
          onCurrentChange: unref(methods2).handleCurrentChange,
          onSizeChange: unref(methods2).handleSizeChange
              ...
              item.show ? (openBlock(), createBlock(_component_el_form_item, {
                ...
                default: withCtx(() => [
                  item.slot ? renderSlot(_ctx.$slots, item.slot, {
                    key: 0,
                    data: item
                  }, void 0, true) : (openBlock(), createBlock(_sfc_main$6, {
                    key: 1,
                    item,
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
              ...
              createVNode(_component_el_space, null, {
                default: withCtx(() => [
                  createVNode(_component_el_button, {
                    ...
                    onClick: ($event) => unref(methods2).del(item.id)
                  ...
                  __props.btnType == "right" && index == unref(lists).length - 1 ? (openBlock(), createBlock(_component_el_button, {
                    ...
                    onClick: _cache[0] || (_cache[0] = ($event) => unref(methods2).add())
        ...
        __props.btnType == "bottom" ? (openBlock(), createElementBlock("div", _hoisted_2, [
          createVNode(_component_el_button, {
            ...
            type: "primary",
            style: { width: "100%" },
            onClick: _cache[1] || (_cache[1] = ($event) => unref(methods2).add())
          }, {
            default: withCtx(() => [
              createTextVNode("新增")
            ]),
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: "yh-grid",
        style: normalizeStyle({ "grid-template-columns": unref(methods2).setColumns(), "grid-template-rows": unref(methods2).setRows() })
      }, [
